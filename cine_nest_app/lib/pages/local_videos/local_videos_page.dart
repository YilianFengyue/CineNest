...
class _LocalVideosPageState extends State<LocalVideosPage> {
  ...
  String _pcPlayerUrl() {
    final room = Uri.encodeComponent(_roomController.text.trim().isEmpty
        ? 'cinenest'
        ...
        children: [
          ...
          if (_loading)
            ...
            const _MessageCard(
              ...
              message:
                  r'Put mp4/mkv/mov/webm/m3u8/avi files into D:\AndoridProject\LocalVideos, then tap Rescan.',
            )
          else
            ..._videos.map(
              (video) => Card(

...
class _ForumDetailPageState extends State<ForumDetailPage> {
  ...
  final _nicknameController = TextEditingController(text: ForumIdentity.nickname);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _StatsItem(label: '评论', value: '${post.commentCount}', selected: true),
              ...
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: value,
                    style: TextStyle(
                      color: selected ? const Color(0xff202124) : const Color(0xff777777),
...
class _BottomActions extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final likeColor = post.likedByMe ? const Color(0xffff7a00) : const Color(0xff202124);
    return SafeArea(
      top: false,
      child: Container(
        height: 58,
